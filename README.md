...
## Features (Prototype)
- **Mock Authentication**: Sign in as Alice (Rider) or Ben (Driver) using @uni-due.de emails.
- **Rider Flow**: Create ride requests for University of Duisburg-Essen, view matched offers, and book rides.
...
2.  **Sign in as Alice**: Use `alice@uni-due.de` to sign in as a Rider.
...
5.  **Sign in as Ben**: Logout and sign in as `ben@uni-due.de` (Driver).
